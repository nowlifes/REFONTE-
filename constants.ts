...
export const CHALLENGES_FR: ChallengeDef[] = [
  ...
  { id: 14, text: "Chanter un refrain en imitant quelqu'un de célèbre", type: ChallengeType.WITNESS },
  ...
  { id: 21, text: "Échanger un vêtement avec un autre joueur", type: ChallengeType.WITNESS },
...
export const CHALLENGES_EN: ChallengeDef[] = [
  ...
  { id: 14, text: "Sing a chorus while imitating someone famous", type: ChallengeType.WITNESS },
  ...
  { id: 21, text: "Swap an item of clothing with another player", type: ChallengeType.WITNESS },
